        ...
        symlinks = {
          ...
          "mods" = with pkgs;
            linkFarmFromDrvs "mods" (
              builtins.attrValues {
                Fabric-API = fetchurl {
                  # Fabric API is a core library for Fabric mods
                ...
                Lithium = fetchurl {
                  # Lithium is a performance optimization mod
                ...
                AppleSkin = fetchurl {
                  # AppleSkin provides information about food and hunger
                  # You may install it on the client side as well
                ...
                Noisium = fetchurl {
                  # Nosium optimize chunk generation
                ...
                DistantHorizon = fetchurl {
                  # Distant Horizons allows for rendering distant terrain
                  # You may install it on the client side as well
                ...
                BannerFlags = fetchurl {
                  # Banner Flags adds flags (rotated banners) to the game
                ...
                Terralith = fetchurl {
                  # Terralith is a world generation mod that adds new biomes and structures
                ...
                SpawnAnimations = fetchurl {
                  # Spawn Animations adds animations to mob spawns
                ...
                StructoryTowers = fetchurl {
                  # Structory Towers adds new tower structures to the game
                ...
                Polymer = fetchurl {
                  # Polymer is a mod that allow client-side mods to be distributed as a resource pack
                ...
                PolyDecoration = fetchurl {
                  # PolyDecorations adds decorative blocks and items
                ...
                PolySit = fetchurl {
                  # PolySit allows players to sit on blocks
                ...
                PolyChess = fetchurl {
                  # PolyChess is a chess mod for Minecraft
                ...
                MoreFurnaces = fetchurl {
                  # MoreFurnaces adds more furnace types to the game
                ...
                Spiders2_0 = fetchurl {
                  # Spiders 2.0 make spiders rotating when climbing walls
                ...
                ArmorStandEditor = fetchurl {
                  # Armor Stand Editor allows players to edit armor stands
                ...
                ServerBackpacks = fetchurl {
                  # ServerBackpacks allows players to have backpacks that store items
                ...
                Filament = fetchurl {
                  # Filament is a mod that adds new lighting and visual effects
                ...
                TomsAdditionsDecoAndFurnitures = fetchurl {
                  # Toms Additions Deco and Furnitures adds decorative blocks and furniture
                ...
                TomsAdditionsStones = fetchurl {
                  # Toms Additions Stones adds new stone types and blocks
                ...
                TomsAdditionsPlanks = fetchurl {
                  # Toms Additions Planks adds new wood types and planks
                ...
                TomsAdditionsConcrete = fetchurl {
                  # Toms Additions Concrete adds concrete blocks
                ...
                TomsAdditionsMobs = fetchurl {
                  # Toms Additions Mobs adds new mobs to the game
                ...
                RightClickHarvest = fetchurl {
                  # RightClickHarvest allows players to harvest crops by right-clicking
                ...
                DoubleDoor = fetchurl {
                  # DoubleDoor allows players to open double doors with a single click
                ...
                UniversalGraves = fetchurl {
                  # Universal Graves allows players to have graves that store items on death
                ...
                BoruvkaFood = fetchurl {
                  # Boruvka Food adds new food items and recipes
                ...
                BoruvkaFoodExotic = fetchurl {
                  # Boruvka Food Exotic adds exotic food items and recipes
                  # Note: This mod requires Boruvka Food to be installed
                ...
                SleepWarp = fetchurl {
                  # SleepWarp allows players to warp to their bed spawn point
                ...
                Ouch = fetchurl {
                  # Ouch displays damages done to targets
                ...
                Danse = fetchurl {
                  # Danse is a mod that adds dance emotes and animations
                ...
                Collective = fetchurl {
                  # Collective is a library mod that provides common functionality for other mods
                ...
                ArchitecturyAPI = fetchurl {
                  # Architectury API is a cross-platform modding library
                ...
                Balm = fetchurl {
                  # Balm is a modding library for Fabric mods
                ...
                JamLib = fetchurl {
                  # JamLib is a library mod for Fabric mods
